define([
    ...
    module.directive('ttcmsReservationAreasList', [
        'ttcmsSettings',
        function (ttcmsSettings) {
            return {
                ...
                templateUrl: ttcmsSettings.startingRoute + '/modules/ticketing/ticketreservations/views/_reservationareas.list.html',
                controller: [
                    '$scope',
                    'TicketReservations',
